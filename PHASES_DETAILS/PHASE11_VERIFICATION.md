...
- [x] POST handler registered at `/chargingdata/{ChargingDataRef}/release`
...
### 4. HTTP Methods
- [x] OPTIONS method implemented for `/chargingdata/{ChargingDataRef}/release`
...
- [x] Metrics collection supported for Release stub invocations

## Functionality Verification

### 1. Valid UUID with 501 Response
```powershell
curl -X POST http://localhost:8080/nchf-convergedcharging/v2/chargingdata/123e4567-e89b-12d3-a456-426614174000/release -H "Content-Type: application/json" -d '{"test": "data"}'
```
...
```json
{
  ...
  "detail": "Release operation is not implemented yet",
...
```powershell
curl -X POST http://localhost:8080/nchf-convergedcharging/v2/chargingdata/invalid-uuid/release -H "Content-Type: application/json" -d '{"test": "data"}'
```
...
```json
{
  ...
  "instance": "/chargingdata/invalid-uuid/release"
}
```
...
```powershell
curl -X POST http://localhost:8080/nchf-convergedcharging/v2/chargingdata/123e4567-e89b-12d3-a456-426614174000/release -H "Content-Type: text/plain" -d "test data"
```
...
```powershell
curl -X POST http://localhost:8080/nchf-convergedcharging/v2/chargingdata/123e4567-e89b-12d3-a456-426614174000/release -H "Content-Type: application/json" -H "Accept: application/xml" -d '{"test": "data"}'
```
...
```powershell
curl -X OPTIONS http://localhost:8080/nchf-convergedcharging/v2/chargingdata/123e4567-e89b-12d3-a456-426614174000/release
```
...
```powershell
curl -X GET http://localhost:8080/nchf-convergedcharging/v2/chargingdata/123e4567-e89b-12d3-a456-426614174000/release
```
